...
import { IDisposable, DisposableDelegate } from 'phosphor/lib/core/disposable';
...
namespace Private {
  ...
  function createSplash() {
    ...
    polygon1.setAttribute(
      'points',
      '0.5,177.5 0.5,71.5 119,0.9 119,106.9 77.3,131.7'
    );
    ...
    polygon2.setAttribute(
      'points',
      '219.3,88.4 219.3,194.4 100.8,265 100.8,159 142.4,134.1'
    );
    ...
    polygon3.setAttribute(
      'points',
      '0.5,177.5 0.5,71.5 119,0.9 119,106.9 77.3,131.7'
    );
    g3.appendChild(polygon3);
    const polyline3 = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'polyline'
    );
    ...
    polygon4.setAttribute(
      'points',
      '219.3,88.4 219.3,194.4 100.8,265 100.8,159 142.4,134.1'
    );
    g4.appendChild(polygon4);
    const polyline4 = document.createElementNS(
      'http://www.w3.org/2000/svg',
      'polyline'
    );
...
const plugins: JupyterFrontEndPlugin<any>[] = [extension, splash];
